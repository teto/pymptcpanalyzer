...
class CrossSubflowInterArrival(plot.Matplotlib):
    ...
    def plot(self, main, args, **kwargs):
        ...
        # print("data=", data)
        print("args", args)
        data = main.data.dropna(subset="mptcpstream")
        print("data=", data)
...
class InterArrivalTimes(plot.Matplotlib):
    ...
    def default_parser(self):
        ...
        # dest="crosssubflows", help="Consider only cross-subflow arrivals")
        parser.add_argument(
            "attribute", choices=self.available,
    ...
    def plot(self, main, args, **kwargs):
        data = main.data
        dat = self.filter_ds(
            data, mptcpstream=args.mptcpstream, ipsrc=args.sender_ips
        )
